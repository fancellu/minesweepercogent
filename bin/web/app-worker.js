const cacheName = "app-" + "c51121f7578b8b3f881c3a6d76929db17a07bbc3";
const resourcesToCache = ["app.css","app.js","app.wasm","manifest.webmanifest","wasm_exec.js","index.html"];

self.addEventListener("install", (event) => {
  console.log("installing app worker c51121f7578b8b3f881c3a6d76929db17a07bbc3");
...
self.addEventListener("activate", (event) => {
  ...
  console.log("app worker c51121f7578b8b3f881c3a6d76929db17a07bbc3 is activated");
});
